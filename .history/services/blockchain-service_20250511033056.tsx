...
class BlockchainService {
  ...
  async registerProduct(p0: { ipfsUrl: string; policyId: string; tokenName: string; txHash: any; name: string; type: string; quantity: string; unit: string; location: string; description: string; harvestDate: string; price: string; nutrientContent: string; pesticidesUsed: string; waterUsage: string; soilType: string; certifications: string; }, p1: string): Promise<{
    productId(productId: any): unknown; mnemonic: string[] 
}> {
    try {
